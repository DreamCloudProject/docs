---
title: 'Einführung'
description: 'Wie MastermindCMS APIs aufgerufen werden (WebSocket/STOMP und REST)'
---

Dieser Abschnitt erklärt die zwei API-Stile, die MastermindCMS-Clients verwenden:

- WebSocket API (STOMP) für interaktive, ereignisbasierte Requests und SSR/UI-Updates
- REST API für Authentifizierung sowie Datei-/Daten-Operationen (und ein HTTP-Fallback für Service-Calls)
...
- WebSocket-JSON-Handler akzeptieren optional ein JWT über den nativen Header `Authorization: Bearer <token>`.
