...
<ResponseField name="searchCustomerActivityEvents" type="Page<ActivityDataItem>">
...
```json
{
  ...
  "scope": "PROTOTYPE",
  "functionName": "searchCustomerActivityEvents",
  "args": [
    {
      "0": null
    }
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `sr` | `SearchRequest` | Übergeben über `args[0].0`. |
...
<ResponseField name="getCustomersActivityChart" type="ChartData">
...
```json
{
  "beanId": "customerAnalyticsServiceImpl",
  "scope": "PROTOTYPE",
  "functionName": "getCustomersActivityChart",
  "args": [
    {
      "0": null
    }
