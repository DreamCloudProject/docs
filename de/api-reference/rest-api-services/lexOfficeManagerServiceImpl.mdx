---
title: 'lexOfficeManagerServiceImpl'
description: 'Aufruf öffentlicher Servicemethoden über die REST API: lexOfficeManagerServiceImpl'
---
...
```json
{
  "beanId": "lexOfficeManagerServiceImpl",
  "scope": "PROTOTYPE",
