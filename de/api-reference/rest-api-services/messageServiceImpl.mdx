...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `chatItem` | `Chat` | Übergeben über `args[0].0`. |
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `messageItem` | `Message` | Übergeben über `args[0].0`. |
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `profile` | `Profile` | Übergeben über `args[0].0`. |
| `chatTopic` | `String` | Übergeben über `args[1].1`. |
| `messageText` | `String` | Übergeben über `args[2].2`. |
...
| --- | --- | --- |
| `messageId` | `String` | Übergeben über `args[0].0`. |
| `attachment` | `Attachment` | Übergeben über `args[1].1`. |
