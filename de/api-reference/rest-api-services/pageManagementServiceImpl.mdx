...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `pageRequest` | `CreatePageRequest` | Übergeben über `args[0].0`. |
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `copyRequest` | `CopyPageRequest` | Übergeben über `args[0].0`. |
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `routeRequest` | `CreateRouteRequest` | Übergeben über `args[0].0`. |
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `prompt` | `LinkedHashMap<String,Object>` | Übergeben über `args[0].0`. |
