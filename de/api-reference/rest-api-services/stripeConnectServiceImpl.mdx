...
description: 'Aufruf öffentlicher Servicemethoden über die REST API: stripeConnectServiceImpl'
---
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `accountDTO` | `StripeAccountDTO` | Übergeben über `args[0].0`. |
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `accountId` | `String` | Übergeben über `args[0].0`. |
| `stripeAccountDTO` | `StripeAccountDTO` | Übergeben über `args[1].1`. |
