...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `translation` | `LocalizedText` | Übergeben über `args[0].0`. |
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `language` | `Language` | Übergeben über `args[0].0`. |
...
| --- | --- | --- |
| `lang` | `String` | Übergeben über `args[0].0`. |
| `translations` | `HashSet<LocalizedText>` | Übergeben über `args[1].1`. |
| `languageOptional` | `Optional<Language>` | Übergeben über `args[2].2`. |
...
| Argument | Typ | Beschreibung |
| --- | --- | --- |
| `tr` | `LocalizedText` | Übergeben über `args[0].0`. |
