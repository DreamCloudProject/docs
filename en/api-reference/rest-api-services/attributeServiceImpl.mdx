...
| Argument | Type | Description |
| --- | --- | --- |
| `measurement` | `Measurement` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `option` | `Option` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `attribute` | `Attribute` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `msr` | `Measurement` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `attr` | `Attribute` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `opt` | `Option` | Passed through `args[0].0`. |
| `optimal` | `boolean` | Passed through `args[1].1`. |
