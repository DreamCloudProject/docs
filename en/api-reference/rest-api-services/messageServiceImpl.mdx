...
| Argument | Type | Description |
| --- | --- | --- |
| `chat` | `Chat` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `chatItem` | `Chat` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `message` | `Message` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `messageItem` | `Message` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `profile` | `Profile` | Passed through `args[0].0`. |
| `chatTopic` | `String` | Passed through `args[1].1`. |
| `messageText` | `String` | Passed through `args[2].2`. |
...
| --- | --- | --- |
| `messageId` | `String` | Passed through `args[0].0`. |
| `attachment` | `Attachment` | Passed through `args[1].1`. |
