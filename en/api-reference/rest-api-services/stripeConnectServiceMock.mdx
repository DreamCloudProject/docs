...
description: 'Calling public service methods through the REST API: stripeConnectServiceMock'
---
...
<ResponseField name="createAccount" type="Account">

| Argument | Type | Description |
| --- | --- | --- |
| `stripeAccountDTO` | `StripeAccountDTO` | Passed through `args[0].0`. |
...
<ResponseField name="updateAccount" type="Account">

| Argument | Type | Description |
| --- | --- | --- |
| `accountId` | `String` | Passed through `args[0].0`. |
| `accountDTO` | `StripeAccountDTO` | Passed through `args[1].1`. |
