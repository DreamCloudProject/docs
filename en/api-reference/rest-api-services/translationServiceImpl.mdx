...
| Argument | Type | Description |
| --- | --- | --- |
| `translation` | `LocalizedText` | Passed through `args[0].0`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `language` | `Language` | Passed through `args[0].0`. |
...
| --- | --- | --- |
| `lang` | `String` | Passed through `args[0].0`. |
| `translations` | `HashSet<LocalizedText>` | Passed through `args[1].1`. |
| `languageOptional` | `Optional<Language>` | Passed through `args[2].2`. |
...
| Argument | Type | Description |
| --- | --- | --- |
| `tr` | `LocalizedText` | Passed through `args[0].0`. |
