---
title: 'Введение'
description: 'Как вызывать API MastermindCMS (WebSocket/STOMP и REST)'
---

В MastermindCMS используются два стиля API:

- WebSocket API (STOMP) для интерактивных, событийных запросов и SSR/UI-обновлений
- REST API для аутентификации и операций с файлами/данными (и HTTP-фолбэк для сервисных вызовов)
...
- JSON-обработчики WebSocket могут принимать JWT через native header `Authorization: Bearer <token>`.
...
### Upload, download, assets, reports
