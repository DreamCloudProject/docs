...
| Аргумент | Тип | Описание |
| --- | --- | --- |
| `measurement` | `Measurement` | Передаётся через `args[0].0`. |
...
| Аргумент | Тип | Описание |
| --- | --- | --- |
| `option` | `Option` | Передаётся через `args[0].0`. |
...
| Аргумент | Тип | Описание |
| --- | --- | --- |
| `attribute` | `Attribute` | Передаётся через `args[0].0`. |
...
| Аргумент | Тип | Описание |
| --- | --- | --- |
| `msr` | `Measurement` | Передаётся через `args[0].0`. |
...
<ResponseField name="mapAttributeToDto" type="AttributeDTO">

| Аргумент | Тип | Описание |
| --- | --- | --- |
| `attr` | `Attribute` | Передаётся через `args[0].0`. |
...
```json
{
  "beanId": "attributeServiceImpl",
  "scope": "PROTOTYPE",
  "functionName": "mapAttributeToDto",
  "args": [
    {
      "0": null
    }
...
<ResponseField name="mapOptionToDto" type="OptionDTO">

| Аргумент | Тип | Описание |
| --- | --- | --- |
| `opt` | `Option` | Передаётся через `args[0].0`. |
| `optimal` | `boolean` | Передаётся через `args[1].1`. |
...
<ResponseField name="mapMeasurementToDto" type="MeasurementDTO">
...
```json
{
  "beanId": "attributeServiceImpl",
  "scope": "PROTOTYPE",
  "functionName": "mapMeasurementToDto",
  "args": [
    {
      "0": null
    }
