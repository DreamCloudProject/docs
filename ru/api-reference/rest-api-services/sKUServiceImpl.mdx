...
| Аргумент | Тип | Описание |
| --- | --- | --- |
| `sku` | `SKU` | Передаётся через `args[0].0`. |
...
<ResponseField name="mapSkuToDto" type="SkuDTO">
...
<ResponseField name="uploadSKU" type="void">
...
<ResponseField name="getFallIntoProducts" type="LinkedHashSet<EmbeddedBean>">

| Аргумент | Тип | Описание |
| --- | --- | --- |
| `productIds` | `String[]` | Передаётся через `args[0].0`. |
...
```json
{
  "beanId": "sKUServiceImpl",
  "scope": "PROTOTYPE",
  "functionName": "getFallIntoProducts",
  "args": [
    {
      "0": null
    }
