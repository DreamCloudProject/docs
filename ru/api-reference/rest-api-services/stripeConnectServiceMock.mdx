...
| Аргумент | Тип | Описание |
| --- | --- | --- |
| `stripeAccountDTO` | `StripeAccountDTO` | Передаётся через `args[0].0`. |
...
| Аргумент | Тип | Описание |
| --- | --- | --- |
| `accountId` | `String` | Передаётся через `args[0].0`. |
| `accountDTO` | `StripeAccountDTO` | Передаётся через `args[1].1`. |
